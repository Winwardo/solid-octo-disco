...
exec "$JAVA" $JAVA_OPTS $MAXHEAP $JAVA_OPTS_SCRIPT $ORIENTDB_SETTINGS $MAXDISKCACHE -Djava.util.logging.config.file="$LOG_FILE" -Dorientdb.config.file="$CONFIG_FILE" -Dorientdb.www.path="$WWW_PATH" -Dorientdb.build.number="2.1.x@rddb5c0b4761473ae9549c3ac94871ab56ef5af2c; 2016-02-15 10:45:12+0000" -cp "$ORIENTDB_HOME/lib/orientdb-server-2.1.11.jar:$ORIENTDB_HOME/lib/*" $* com.orientechnologies.orient.server.OServerMain
