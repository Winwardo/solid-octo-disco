...
class SocialWebResults extends Component {
  componentDidMount() {
    if (this.props.socialWebVisible && this.props.feed.posts.length > 0) {
...
SocialWebResults.propTypes = {
  feed: React.PropTypes.object,
  mostFrequent: React.PropTypes.object,
};

export default SocialWebResults;
